...
apt install -y php-curl snmp passing-the-hash enum4linux ranger htop ghex cherrytree nfs-common cifs-utils ldap-utils xclip feh exploitdb scrub i3lock cmatrix figlet lolcat sl scrot rinetd rlwrap knockd trash-cli gcc-multilib crackmapexec micro rofi snapd > /dev/null 2>&1
